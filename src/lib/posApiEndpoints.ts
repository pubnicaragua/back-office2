// API Endpoints para sincronización POS ↔ Back Office
...
export const POS_API_ENDPOINTS = {
  ...
  getUserRoles: (userId: string) => ({
    url: `/auth/roles?usuario_id=${userId}`,
    method: 'GET',
  ...
  getTerminalConfig: (empresaId: string) => ({
    url: `/pos_terminals?empresa_id=eq.${empresaId}&select=*`,
    method: 'GET',
  ...
  getProducts: (empresaId: string) => ({
    url: `/productos?empresa_id=eq.${empresaId}&activo=eq.true&select=*`,
    method: 'GET',
